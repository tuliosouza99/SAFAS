...
@numpy.deprecate(
    message="`bytescale` is deprecated in SciPy 1.0.0, " "and will be removed in 1.2.0."
)
...
@numpy.deprecate(
    message="NO, this `imresize` function will NEVER be deprecated in any STUPID scipy updates."
)
